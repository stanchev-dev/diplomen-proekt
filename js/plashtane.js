document.addEventListener('DOMContentLoaded', () => {
    const products = {
        ...
        'TK-303': {
            name: 'Автомобилна гума Michelin Pilot Sport 4',
            price: 220.00,
            priceText: '220 лв.',
            image: 'images/tire-compressor.webp',
            description: 'Висок клас лятна гума Michelin Pilot Sport 4, създадена за отлично сцепление и стабилност при високи скорости. Осигурява прецизно управление както на сух, така и на мокър път. Подходяща за динамично шофиране и дълъг експлоатационен живот.',
            stock: 10
        },
        'TK-401': {
